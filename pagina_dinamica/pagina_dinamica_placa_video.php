<?php
include 'config.php'; // Arquivo de configuração com a conexão ao banco

// ID do produto passado por query string (?id=1)
$id = isset($_GET['id']) ? $_GET['id'] : 1;

// Consulta SQL para obter os dados do produto
$stmt = $conn->prepare("SELECT * FROM placas_de_video WHERE id = :id");
$stmt->execute(['id' => $id]);
    ...
    <div id="especificacoes-tecnicas" class="especificacoes-tecnicas tabela-container agdasima-regular" style="display: none;">
        <table>
            <?php if ($produto): ?>
                ...
                <tr><th>GPU:</th><td><?= htmlspecialchars($produto['gpu']); ?></td></tr>
                <tr><th>Tecnologia LHR:</th><td><?= htmlspecialchars($produto['tecnologia_lhr']); ?></td></tr>
                <tr><th>Tecnologia Ray Tracing:</th><td><?= htmlspecialchars($produto['tecnologia_ray_tracing']); ?></td></tr>
                <tr><th>Tecnologia DLSS:</th><td><?= htmlspecialchars($produto['tecnologia_dlss']); ?></td></tr>
                <tr><th>Interface:</th><td><?= htmlspecialchars($produto['interface']); ?></td></tr>
                <tr><th>Cuda Cores:</th><td><?= htmlspecialchars($produto['cuda_cores']); ?></td></tr>
                <tr><th>Core Clocks:</th><td><?= htmlspecialchars($produto['core_clocks']); ?></td></tr>
                <tr><th>Velocidade de memória:</th><td><?= htmlspecialchars($produto['velocidade_memoria']); ?></td></tr>
                <tr><th>Tamanho da Memória:</th><td><?= htmlspecialchars($produto['tamanho_memoria']); ?></td></tr>
                <tr><th>Barramento de memória:</th><td><?= htmlspecialchars($produto['barramento_memoria']); ?></td></tr>
                <tr><th>Saídas:</th><td><?= htmlspecialchars($produto['saidas']); ?></td></tr>
                <tr><th>Suporte HDCP:</th><td><?= htmlspecialchars($produto['suporte_hdcp']); ?></td></tr>
                <tr><th>Consumo de Energia:</th><td><?= htmlspecialchars($produto['consumo_energia']); ?></td></tr>
                <tr><th>Conectores de alimentação:</th><td><?= htmlspecialchars($produto['conectores_alimentacao']); ?></td></tr>
                <tr><th>Fonte Recomendada:</th><td><?= htmlspecialchars($produto['fonte_recomendada']); ?></td></tr>
                <tr><th>Dimensões:</th><td><?= htmlspecialchars($produto['dimensoes']); ?></td></tr>
                <tr><th>Suporte Versão DirectX:</th><td><?= htmlspecialchars($produto['suporte_versao_directx']); ?></td></tr>
                <tr><th>Suporte Versão OpenGL:</th><td><?= htmlspecialchars($produto['suporte_versao_opengl']); ?></td></tr>
                <tr><th>Quantidade Máxima de Telas:</th><td><?= htmlspecialchars($produto['quantidade_maxima_telas']); ?></td></tr>
                <tr><th>VR PRONTO:</th><td><?= htmlspecialchars($produto['vr_pronto']); ?></td></tr>
                <tr><th>Tecnologia G-Sync:</th><td><?= htmlspecialchars($produto['tecnologia_g_sync']); ?></td></tr>
                <tr><th>Adaptativo V-Sync:</th><td><?= htmlspecialchars($produto['adaptativo_v_sync']); ?></td></tr>
                <tr><th>Resolução Máxima Digital:</th><td><?= htmlspecialchars($produto['resolucao_maxima_digital']); ?></td></tr>
            <?php else: ?>
