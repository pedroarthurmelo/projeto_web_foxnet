...
Passo 4: Criação do Banco de Dados
    Configuração no DBeaver
        ...
        Navegue até Database
        Crie um novo banco de dados com o nome memoria_ram_db usando as seguintes configurações de conexão:

        Nome do Database: memoria_ram_db
        Host: localhost
        Usuário: root
...
Passo 5: Execução do Script SQL
    Rodando o Script SQL
        Dentro do DBeaver, selecione o banco de dados memoria_ram_db que acabou de criar.
...
Passo 6: Abrindo a Página no Navegador
    Abra o seu navegador e acesso o localhost do Xampp, em seguida acesse a pagina_dinamica_memoria_ram.php
